...
class Allergen(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["category", "is_active"], name="allergen_cat_active_idx"
            ),
        ]
...
class UserAllergy(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["user", "is_active"], name="userallergy_user_active_idx"
            ),
            models.Index(
    ...
    def save(self, *args, **kwargs):
        ...
        Guarantees data integrity regardless of how the object is saved
        (admin, form, script).
        """
        self.full_clean()
