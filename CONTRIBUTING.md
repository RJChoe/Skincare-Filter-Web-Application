...
1. Write tests for all new features (minimum 70% coverage for new code)
2. Test happy path, edge cases, and error scenarios
3. Add integration tests with `@pytest.mark.integration`
4. Ensure overall coverage meets 50% minimum (Phase 1 threshold)
...
- **Minimum Coverage:** 70% for new code, 50% overall (Phase 1)
...
3. **Never skip tests** - All new features require tests with minimum 70% coverage
